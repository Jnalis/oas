            ...
            <div class="col-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.olevel_completion_status.update', $completion->id) }}" method="post">
                            @csrf
                            @method('put')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" type="text"
                                        placeholder="Eg: Certificates" id="level_completion_status"
                                        name="level_completion_status" value="{{ old('level_completion_status', $completion->level_completion_status) }}">
                                </div>
                            </div>
