            ...
            <div class="col-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.application_type.update', $application->id) }}" method="post">
                            @csrf
                            @method('put')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text"
                                        ...
                                        name="application_type" value="{{ old('application_type', $application->application_type) }}">
                                </div>
                            </div>
