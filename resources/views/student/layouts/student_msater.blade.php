...
<head>
    ...
    <meta content="Online Student Application" name="description" />
    <meta content="Online Student Application" name="author" />
    <!-- App favicon -->
    ...
    <link rel="stylesheet" href="{{ asset('backend/assets/mystyle/student_main.css') }}">
...
<body data-topbar="dark">
    ...
    <div id="layout-wrapper">
        ...
        {{-- Header Starts --}}
        @include('student.components.header_master')
        {{-- Header Ends --}}
        ...
        <div class="main-content">
            ...
            {{-- Footer start --}}
            @include('student.components.footer_master')
            {{-- Footer Ends --}}
